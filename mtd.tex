...
\begin{enumerate}
  ...
  \item Subtract the mean of each column and transform $Y$ into principal components $Z_q$ with $q = 5$ PCs, accounting for over 99\% of the variance as shown in FIG.~\ref{fig:pc_var}.
\end{enumerate}
