...
\end{equation}
While this is a rough assumption, it is perhaps more admissible than it initially seems, especially since the principal components automatically include correlations among observables.
