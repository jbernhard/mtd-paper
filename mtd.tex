...
\widefig{prior_draws}{
  Prior model calculations using Glauber (top) and KLN (bottom) initial conditions.
  From left to right:
...
\widefig{post_draws}{
  Random realizations of the calibrated posterior for the Glauber (top) and KLN (bottom) models.
